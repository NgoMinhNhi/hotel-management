            	...
            	<div class="row">
            		<nav aria-label="breadcrumb">
					  <ol class="breadcrumb">
					    ...
					    <li class="breadcrumb-item active" aria-current="page">Add ${ standard } room</li>
					  </ol>
					</nav>
            	</div>
                <div class="row">
                    <div class="col-md-8">
                    <h2 class="roomId">Room</h2>
					...
					<form:form class="login100-form validate-form" 
						...
						<div class="wrap-input100 validate-input" data-validate="Phone number is required">
							...
							<span class="focus-input100"></span>
							<form:input class="display-none" path="standard" value="${standard }" />
						</div>
