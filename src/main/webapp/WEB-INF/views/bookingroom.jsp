                                    ...
                                    <c:if test="${not empty listRoom}">
                                    	<c:forEach var="room" items="${ listRoom}">
                                    		<c:if test="${ room.standard eq single}">
												...
												<a href="<c:url value="/add-single-room/" />"><div class="room f-s-20" alt="Add room">+</div></a>
                                </div>
                                    ...
                                    <c:if test="${not empty listRoom}">
                                    	<c:forEach var="room" items="${ listRoom}">
                                    		<c:if test="${ room.standard eq douple}">
                                    			...
                                    			<a href="<c:url value="/add-douple-room/" />"><div class="room f-s-20" alt="Add room">+</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
