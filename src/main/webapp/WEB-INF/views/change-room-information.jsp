                ...
                <div class="row">
					...
					<form class="login100-form validate-form" method="post" action="<c:url value="/bookingroom/" />">
						...
						<div class="wrap-input100 validate-input" data-validate = "Person ID is required">
							...
							<input type="radio" name="kindOfRoom" checked value="single-room">Single Room<br />
							<input type="radio" name="kindOfRoom" value="double-room">Double Room
							<span class="focus-input100"></span>
						</div>
	
						<div class="wrap-input100 validate-input" data-validate="Phone number is required">
							<span class="label-input100">Room status</span><br/>
							<input type="radio" required  name="roomStatus" value="available" checked>Available<br/>
							<input type="radio" required  name="roomStatus" value="maintenance" >Maintenance
							<span class="focus-input100"></span>
						</div>
